                            ...
                            <div class="filter__block-list-subcate">
                                <div class="list-subcate">
                                        <?php
                                            ...
                                            $sql="SELECT * FROM manufacturers where id_category=5";
                                            $result=mysqli_query($conn, $sql);
                                            foreach($result as $manuf):
                                        ?>
                                        <a class="item-subcate" href="smartwatch.php?search=<?php echo $manuf['name'] ?>">
                    ...
                    <div class="home-product" style="width: 100%">
                        ...
                        <div class="grid wide">
                            ...
                            <?php
                                        ...
                                        $se_smartwatches = mysqli_query($conn, $sql);
                                ...
                                <div class="col l-2-4 m-4 c-6">
                                    <a class="home-product-item" href="detail_products.php?id=<?php echo $each_smartwatch['id'] ?>">
                                        ...
                                        <div class="home-product-item__action">
                                            ...
                                            <span class="home-product-item__sold"><?php echo number_format($each_smartwatch['sold']);?> đã bán</span>
                                        </div>
                                        <?php if ($each_smartwatch['sold'] > 9) { ?>
