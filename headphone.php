                            ...
                            <div class="filter__block-list-subcate">
                                <div class="list-subcate">
                                        <?php
                                            ...
                                            $sql="SELECT * FROM manufacturers where id_category=4";
                                            $result=mysqli_query($conn, $sql);
                                            foreach($result as $manuf):
                                        ?>
                                        <a class="item-subcate" href="headphone.php?search=<?php echo $manuf['name'] ?>">
                    ...
                    <div class="home-product" style="width: 100%">
                        ...
                        <div class="grid wide">
                            ...
                            <?php
                                        ...
                                        $all_product=(new data)->count_paging_headphone1($search);
                                        ...
                                        $se_headphones = mysqli_query($conn, $sql);
                                        foreach($se_headphones as $each_headphone): ?>
                                <div class="col l-2-4 m-4 c-6">
                                    <a class="home-product-item" href="detail_products.php?id=<?php echo $each_headphone['id'] ?>">
                                        <div class="home-product-item__img" style="background-image: url(<?php echo $each_headphone['image'] ?>);"></div>
                                        <h4 class="home-product-item__name"><?php echo $each_headphone['name'] ?></h4>
                                        <div class="home-product-item__price">
                                            <span class="price-old"><?php echo number_format($each_headphone['price']) ?> đ</span>
                                            <span class="price-current"><?php echo number_format($each_headphone['price_sale']) ?> đ</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            ...
                                            <span class="home-product-item__sold"><?php echo number_format($each_headphone['sold']) ?> đã bán</span>
                                        </div>
                                        <?php if ($each_headphone['sold'] > 9) { ?>
