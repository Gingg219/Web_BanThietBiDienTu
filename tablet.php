                                ...
                                <div class="col l-2-4 m-4 c-6">
                                    <a class="home-product-item" href="#">
                                        ...
                                        <div class="home-product-item__price">
                                            <span class="home-product-item__price-old"><?php echo $each_tablet['price'] ?></span>
                                            <span class="home-product-item__price-current"><?php echo $each_tablet['price_sale'] ?></span>
                                        </div>
