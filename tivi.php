                                ...
                                <div class="box-list-subcate">
                                    <div class="list-subcate">
                                        <?php
                                            ...
                                            $sql="SELECT * FROM manufacturers where id_category=8";
                                            $result=mysqli_query($conn, $sql);
                                            foreach($result as $manuf):
                                        ?>
                                        <a class="item-subcate" href="tivi.php?search=<?php echo $manuf['name'] ?>">
                    ...
                    <div class="home-product" style="width: 100%">
                        ...
                        <div class="grid wide">
                            ...
                            <?php
                                        ...
                                        $all_product=(new data)->count_paging_tivi1($search);
                                        ...
                                        switch ($check) {
                                            case '1':
                                                $sql = "SELECT products.*,
                                                        ...
                                                        WHERE manufacturers.id_category=8 and manufacturers.name like '%$search%'
                                ...
                                <div class="col l-2-4 m-4 c-6">
                                    <a class="home-product-item" href="detail_products.php?id=<?php echo $each_smartphone['id'] ?>">
                                        ...
                                        <div class="home-product-item__action">
                                            ...
                                            <span class="home-product-item__sold"><?php echo number_format($each_smartphone['sold']);?> đã bán</span>
                                        </div>
                                        <?php if ($each_smartphone['sold'] > 9) { ?>
